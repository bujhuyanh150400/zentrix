    ...
    <LayoutScrollApp>
        ...
        <XStack alignItems={"center"} gap="$4">
          ...
          >
            ...
            <View
              ...
              borderRadius={"100%"}
            >
              <Paragraph color={DefaultColor.white} fontSize={12}>
                0
              </Paragraph>
            </View>
          </TouchableOpacity>
      ...
      >
        <XStack
          ...
          marginBottom={16}
        >
          <Paragraph fontWeight={700} fontSize={sizeDefault.md}>
            Đề xuất
          </Paragraph>
          <TouchableOpacity
            onPress={() => {
        ...
        <YStack gap={"$4"}>
          {queryAssetTrading.isLoading || queryAssetTrading.isRefetching ? (
            ...
            AssetTradingData &&
            AssetTradingData.length > 0 &&
            AssetTradingData.map((symbol, index) => (
      ...
      <YStack marginTop={20} gap={26}>
        <Text style={{ fontSize: sizeDefault["3xl"], fontWeight: 700 }}>
          Tin tức thị trường
        </Text>
