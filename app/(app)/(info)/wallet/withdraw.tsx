...
import {useMutationWithdrawWallet, useWithdrawWalletUserForm} from "@/services/wallet/hook";
import {WithdrawTransactionWalletRequest} from "@/services/wallet/@types";
import {useCallback, useEffect} from "react";
import {useMutationWithdraw} from "@/services/account/hook";
...
export default function WithdrawUserScreen(){
    ...
    const {control, handleSubmit,  formState: {errors}} = useWithdrawWalletUserForm();
