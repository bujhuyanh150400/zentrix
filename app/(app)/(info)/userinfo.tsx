...
export default function UserInfoScreen() {
  ...
  return (
    <LayoutScrollApp style={{ backgroundColor: DefaultColor.white }}>
      <Paragraph fontWeight={700} fontSize={sizeDefault.xl} marginBottom={16}>
        Tài khoản
      </Paragraph>
      <TouchableOpacity
        onPress={() => {
        ...
        <XStack gap="$4" alignItems="center" flex={1}>
          ...
          <YStack gap="$2">
            ...
            {!userProfileQuery.isFetching &&
              userProfile?.status === _VerifyUserStatus.IN_ACTIVE && (
                <Paragraph fontSize={14} fontWeight={500} color="#ccc">
                  Nhấn để xác minh hồ sơ
                </Paragraph>
              )}
          </YStack>
        </XStack>
        ...
        <YGroup separator={<Separator />}>
          <YGroup.Item>
            <XStack
              ...
              alignItems="center"
            >
              <Paragraph fontWeight={500} color="#7D7D7D">
                Tên tài khoản
              </Paragraph>
          ...
          <YGroup.Item>
            ...
            >
              ...
              <Paragraph fontWeight={500}>
                {userProfile.dob ? userProfile.dob : "Chưa có thông tin"}
              </Paragraph>
            </XStack>
          </YGroup.Item>
          <YGroup.Item>
