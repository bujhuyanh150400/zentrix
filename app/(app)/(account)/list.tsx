                                ...
                                { account_id: item.id },
                                {
                                  onSuccess: async () => {
                                    ...
                                    showMessage({
                                      ...
                                      description:
                                        "Xóa tài khoản hoạt động thành công",
                                      type: "success",
                                      duration: 3000,
                                    });
              ...
              renderLeftActions={() => {
                ...
                return (
                  <RectButton
                    ...
                    onPress={() => {
                      Alert.alert(
                        "Chỉnh sửa tài khoản giao dịch",
                        "Ban có chắc muốn chỉnh tài khoản này thành tài khoản giao dịch không ?",
                        [
                          {
                            text: "Đồng ý",
                            onPress: () => {
                                ...
                                { account_id: item.id },
                                {
                                  onSuccess: async () => {
                                    ...
                                    showMessage({
                                      ...
                                      description:
                                        "Cập nhật tài khoản hoạt động thành công",
                                      type: "success",
                                      duration: 3000,
                                    });
                                    // Đóng swipe khi item bị update status
                  ...
                  <XStack alignItems={"center"} gap={"$2"}>
                    ...
                    <View
                      style={[
                        ...
                        {
                          paddingVertical: 5,
                          backgroundColor: item.account_type.color
                            ? item.account_type.color
                            : DefaultColor.slate[300],
                        },
                      ]}
                    >
          ...
          ListEmptyComponent={() => (
            ...
            >
              <Paragraph fontWeight="bold" theme="alt2">
                Không có tài khoản giao dịch nào
              </Paragraph>
              <Paragraph textAlign="center" theme="alt2">
                Tạo tài khoản để giao dịch trên các thị trường tài chính lớn
                trên thế giới
              </Paragraph>
            </YStack>
          )}
