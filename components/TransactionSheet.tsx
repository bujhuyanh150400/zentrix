...
const TransactionSheet: FC<TransactionSheetProps> = (props) => {
    ...
    }, [props.price, form.trigger_price, form.type_trigger, setError]);
    ...
    }, [props.symbol, props.account, props.open, props.tradeType, setForm]);
    ...
    }, [openMore, props.price, setForm, tab]);
