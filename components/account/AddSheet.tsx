...
import {Button, Card, Form, H2, Input, Label, Paragraph, Separator, XStack, YStack} from "tamagui";
                        ...
                        >
                            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                                <YStack flex={1} justifyContent="space-between" gap={"$3"}>
                                                ...
                                                rules.map((rule, idx) => {
                                                    ...
                                                    return (
                                                        <XStack key={idx} alignItems="center" gap="$2">
                                                            {valid ? (
                                                                <FontAwesome6 name="check" size={sizeDefault.md} color={DefaultColor.green[500]} />
                                                            ) : (
                                                                <FontAwesome6 name="x" size={sizeDefault.md} color={DefaultColor.red[500]} />
                                                            )}
                                                            <Text
                                                                style={{
                                    ...
                                    <Button theme="yellow" fontWeight="bold" borderWidth={1} borderColor="$yellow10"
                                            disabled={!allValid}
                                            backgroundColor={!allValid ? DefaultColor.yellow[100] : DefaultColor.yellow[400]}
                                            onPress={() => {
